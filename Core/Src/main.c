...
int main(void)
{
  ...
  HAL_GPIO_WritePin(ECU_SPK_CUT_GPIO_Port, ECU_SPK_CUT_Pin, 1);
  HAL_GPIO_WritePin(CLUTCH_SLOW_DROP_GPIO_Port, CLUTCH_SLOW_DROP_Pin, 0);
  ...
  HAL_GPIO_WritePin(AUX_1C_GPIO_Port, AUX_1C_Pin, 0);
  HAL_GPIO_WritePin(AUX_2C_GPIO_Port, AUX_2C_Pin, 0);
  HAL_GPIO_WritePin(AUX_1T_GPIO_Port, AUX_1T_Pin, 0);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GSENSE_LED_Pin|HBEAT_Pin|AUX_2C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, AUX_1T_Pin|UPSHIFT_SOL_Pin|DOWNSHIFT_SOL_Pin|CLUTCH_SOL_Pin
                          |CLUTCH_SLOW_DROP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AUX_1C_Pin|ECU_SPK_CUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GSENSE_LED_Pin HBEAT_Pin AUX_2C_Pin */
  GPIO_InitStruct.Pin = GSENSE_LED_Pin|HBEAT_Pin|AUX_2C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : AUX_1T_Pin UPSHIFT_SOL_Pin DOWNSHIFT_SOL_Pin CLUTCH_SOL_Pin
                           CLUTCH_SLOW_DROP_Pin */
  GPIO_InitStruct.Pin = AUX_1T_Pin|UPSHIFT_SOL_Pin|DOWNSHIFT_SOL_Pin|CLUTCH_SOL_Pin
                          |CLUTCH_SLOW_DROP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : AUX_1C_Pin ECU_SPK_CUT_Pin */
  GPIO_InitStruct.Pin = AUX_1C_Pin|ECU_SPK_CUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
