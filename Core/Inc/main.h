...
#define AUX2_C_Pin GPIO_PIN_6
#define AUX2_C_GPIO_Port GPIOA
#define AUX1_T_Pin GPIO_PIN_4
#define AUX1_T_GPIO_Port GPIOC
#define GEAR_POS_POT_Pin GPIO_PIN_5
...
#define SLOW_CLUTCH_SOL_Pin GPIO_PIN_9
