...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GSENSE_LED_Pin|HEARTBEAT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, UPSHIFT_SOL_Pin|DOWNSHIFT_SOL_Pin|CLUTCH_SOL_Pin|CLUTCH_SLOW_DROP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ECU_SPK_CUT_GPIO_Port, ECU_SPK_CUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : GSENSE_LED_Pin HEARTBEAT_Pin */
  GPIO_InitStruct.Pin = GSENSE_LED_Pin|HEARTBEAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : UPSHIFT_SOL_Pin DOWNSHIFT_SOL_Pin CLUTCH_SOL_Pin CLUTCH_SLOW_DROP_Pin */
  GPIO_InitStruct.Pin = UPSHIFT_SOL_Pin|DOWNSHIFT_SOL_Pin|CLUTCH_SOL_Pin|CLUTCH_SLOW_DROP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : TRANS_Pin AUX_1C_Pin */
  GPIO_InitStruct.Pin = TRANS_Pin|AUX_1C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : ECU_SPK_CUT_Pin */
  GPIO_InitStruct.Pin = ECU_SPK_CUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ECU_SPK_CUT_GPIO_Port, &GPIO_InitStruct);
